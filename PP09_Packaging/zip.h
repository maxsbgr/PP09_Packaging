...
HZIP CreateZip(const TCHAR *fn, const char *password, int level);
HZIP CreateZip(void *buf,unsigned int len, const char *password, int level);
HZIP CreateZipHandle(HANDLE h, const char *password, int level);
